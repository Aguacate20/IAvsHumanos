...
st.markdown("""
    ...
    @media (max-width: 768px) {
        ...
        div[data-testid="column"]:nth-child(1) img { /* Imagen IA */
            ...
            left: 320px !important; /* Mueve horizontalmente. Valores negativos mueven a la izquierda. */
        ...
        .stButton>button {
            margin-top: -180px !important; /* Ajusta este valor para mover el botón verticalmente. */
