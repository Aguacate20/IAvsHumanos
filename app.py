...
st.markdown("""
    ...
    @media (max-width: 768px) {
        ...
        div[data-testid="column"]:nth-child(1) img { /* Imagen IA */
            ...
            left: 375px !important; /* Mueve horizontalmente. Valores negativos mueven a la izquierda. */
            top: 70px !important; /* Mueve verticalmente. Valores positivos mueven hacia abajo. */
        }
        div[data-testid="column"]:nth-child(3) img { /* Imagen Humano */
            ...
            top: 10px !important; /* Mueve verticalmente */
        }

        /* 3. Posición de las Etiquetas "IA" y "Humano" */
        div[data-testid="column"]:nth-child(1) .slider-label { /* Etiqueta IA */
            position: relative; /* ¡CLAVE! */
            left: 100px !important; /* Mueve horizontalmente. Ajusta para alinear con la imagen. */
